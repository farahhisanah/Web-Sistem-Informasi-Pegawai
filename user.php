...
<head>
    ...
    <title>Sistem Kepegawaian - User</title>
  ...
  <div class="container">
    ...
    <div class="row mt-3">
        <table class="table table-striped table-hover">
            ...
            include("koneksi.php");
            $no = 0;
            $sql = mysqli_query($db, "SELECT * FROM tuser");
            ...
            <tr>
                ...
                <td>
                <a href="user_edit.php?id=<?php echo $data['iduser'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                <a href="user_hapus.php?id=<?php echo $data['iduser']?>" onclick=" return confirm('Yakin akan menghapus data?')" class="btn btn-danger btn-sm"> <i class="fas fa-trash-alt"></i>Delete</a>
                </td>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright @ FarahProject 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
